...
export class DrawComponent implements OnInit {
  ...
  private drawPointArray(points: any) {
    this.clearCanvas();
    const x = (this.canvasEl.nativeElement as HTMLCanvasElement).width / 3;
    const y = (this.canvasEl.nativeElement as HTMLCanvasElement).height / 3;
      ...
      .subscribe(
        (result) => {
          ...
          if (
            ...
            this.drawPointArray(this.shapeData.dataPoints);
